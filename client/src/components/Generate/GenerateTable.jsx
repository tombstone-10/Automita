...
const GenerateTable = ({ parentName }) => {
  ...
  const {
    classes_addition,
    set_classes_addition,
    course_addition,
    set_course_addition,
    teacher_addition,
    set_teacher_addition,
    room_addition,
    set_room_addition,
  } = useTimeTables();
          ...
          <table>
            ...
            {course_addition.map((courses, index) => (
              <tr key={index}>
                ...
                <td>
                  {courses.class_assigned.map((singleClass, index) => (
                    <div key={index}>
          ...
          <table>
            ...
            {teacher_addition.map((teachers, index) => (
              <tr key={index}>
                <td>{teachers.name}</td>
                <td>
                  {teachers.class_assigned.map((singleClass, index) => (
                    <div key={index}>
                      {`${singleClass.program_name}-${singleClass.session}-${singleClass.semester}-${singleClass.section}`}
                    </div>
                  ))}
